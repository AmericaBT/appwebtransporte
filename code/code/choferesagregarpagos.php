  ...
  <body>
    <div class="agg-alumnos-choferes">
      ...
      <div class="group-escolaridad">
        <div class="name-campo-6">Ciclo Escolar</div>
        <input type="text" class="input-text-6" placeholder="Ingrese ciclo escolar">
      </div>

      <div class="group-nombre">
        <div class="name-campo-1">Nombre(s)</div>
        <input type="text" class="input-text-1" placeholder="Ingrese nombre">
      </div>

      <div class="group-escuela">
        <div class="name-campo-4">Monto</div>
        <input type="number" class="input-text-4" placeholder="Ingrese monto">
      </div>

      <div class="group-apellidop">
        <div class="name-campo-2">Apellido Paterno</div>
        <input type="text" class="input-text-2" placeholder="Ingrese apellido paterno">
      </div>

      <div class="group-apellidom">
        <div class="name-campo-3">Apellido Materno</div>
        <input type="text" class="input-text-3" placeholder="Ingrese apellido materno">
      </div>
      ...
      <div class="group-turno">
        ...
        <div class="interruptor">
          <input type="radio" id="matutino" name="turno" checked>
          <label for="matutino" class="opcion-izquierda">Matutino</label>
          <input type="radio" id="vespertino" name="turno">
